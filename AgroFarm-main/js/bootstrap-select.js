...
(function(root, factory) {
    ...
    (function($) {
        ...
        $(document).data('keycount', 0).on('keydown.bs.select', '.bootstrap-select [data-bs-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', Selectpicker.prototype.keydown).on('focusin.modal', '.bootstrap-select [data-bs-toggle=dropdown], .bootstrap-select [role="listbox"], .bs-searchbox input', function(e) {
            e.stopPropagation();
        });
